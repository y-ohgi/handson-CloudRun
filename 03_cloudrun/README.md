...
> **[要作図] 図2: 3つの実行モデル**
>
> - **目的:** 「Cloud Run ≒ App Runner」という誤解を壊す。**同じコンテナイメージが中央にあり、そこから3方向に分岐する**という構図にすることが要点
...
> - **補足:** ワーカープールに「URLなし」を明示すると、サービスとの違いが伝わる。AWS 対応(App Runner / ECS RunTask / SQSをポーリングするECS常駐ワーカー)を各分岐の脇に小さく添えてもよい
