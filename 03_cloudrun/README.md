...
> - **完成後の扱い:** `03_cloudrun/imgs/three-execution-models.png` として保存し、**見出しの直下**に `![同じコンテナイメージから分岐する3つの実行モデル](imgs/three-execution-models.png)` として差し込む(見出し → 画像 → 本文の順。キャプション文は付けない)
