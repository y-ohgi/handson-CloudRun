...
> - **完成後の扱い:** `10_advanced/imgs/parallel-tasks-index.png` として保存し、**見出しの直下**に `![並列タスクが環境変数で担当範囲を分ける仕組み](imgs/parallel-tasks-index.png)` として差し込む(見出し → 画像 → 本文の順。キャプション文は付けない)
