...
| 3. Cloud Runとは | `03_cloudrun/README.md` | 修正済み | `fact-check/03_cloudrun.md` | **完成**(正しい28 / 要修正2 / 未確認0。2026-08-26 に #24〜#29、2026-08-30 に #30 を追加) |
...
|---|---|---|---|---|---|
| 章別フラグメント + `aws-comparisons.md` | 17 | **407** | 337 | 54 | **16** |
