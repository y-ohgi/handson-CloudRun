...
**所要時間は10分程度**ですが、アカウント作成と課金有効化は当日に始めると本人確認等で詰まることがあり全体が遅れます。  
**当日にアカウントを作らず、必ず事前にお願いします。**
...
その代わり、詰まったときは次の順番で復帰してください。

1. **その手順の直後にある吹き出しを読む。** 4章以降の主要な手順の末尾には「**成功していれば**」(そこまでで何が表示されていれば正解か)と「**詰まったら**」(よくあるエラーの原因と、そのままコピペして流せる復旧コマンド)が付いています。まずここを見るのが最短です。
